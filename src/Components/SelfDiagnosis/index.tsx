...
const SelfDiagnosis = ({ onGoToFindHospital }: SelfDiagnosisProps) => {
  ...
  if (showTestPage) {
    return (
      <SelfDiagnosisTest
        ...
        onGoToFindHospital={onGoToFindHospital}
      />
    );
  }
...
const SelfDiagnosisTest = ({
  onBack,
  onSaveResult,
  onGoToFindHospital,
}: SelfDiagnosisTestProps) => {
  ...
  const questions: Question[] = [
    {
      id: 1,
      text: "지난 2주 동안 일 또는 다른 활동을 하는 데 흥미나 즐거움을 느끼지 못했다",
    },
    {
      id: 2,
      text: "지난 2주 동안 기분이 가라앉거나 우울하거나 절망적으로 느꼈다",
    },
    {
      id: 3,
      text: "지난 2주 동안 잠들기가 어렵거나 자주 깨거나 반대로 너무 많이 잠을 잤다",
    },
    { id: 4, text: "지난 2주 동안 피곤하다고 느끼거나 에너지가 거의 없었다" },
    {
      id: 5,
      text: "지난 2주 동안 자신에 대해 나쁘게 생각하거나 자신이 실패자라고 느꼈다",
    },
    {
      id: 6,
      text: "지난 2주 동안 신문을 읽거나 TV를 보는 것과 같은 일에 집중하는 것이 어려웠다",
    },
    {
      id: 7,
      text: "지난 2주 동안 다른 사람들이 눈치 챌 정도로 평소보다 말과 행동이 느려졌거나 반대로 평소보다 많이 움직여서 가만히 있을 수 없었다",
    },
      ...
      <S.Container>
        <S.ResultContainer>
          ...
          <S.ResultDescription>
            ...
            {level === "심각함" &&
              "심각한 우울 증상이 있을 수 있습니다. 전문가와 상담하시기 바랍니다."}
          </S.ResultDescription>
          <S.ButtonGroup>
            <S.SecondaryButton onClick={handleRestart}>
              다시 검사
            </S.SecondaryButton>
